...
<article class="product-service-card">
    <a class="product-service-card__image-link" href="{{ route('product-services.selhoz.show', $productService->slug) }}">
    ...
    <div class="product-service-card__content">
        ...
        <a class="product-service-card__more" href="{{ route('product-services.selhoz.show', $productService->slug) }}">
            Подробнее...
        </a>
    </div>
</article>
