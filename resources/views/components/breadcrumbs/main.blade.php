<div class="uni_breadcrumbs">
    <div class="_container">
        ...
        <div itemscope itemtype="https://schema.org/BreadcrumbList" class="breadcrumbs">
            ...
            @elseif (Request::route()->named('product-services.show'))
                <span class="sep"> / </span>
                <span itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                    <a title="Товары и услуги" itemprop="item" href="{{ route('product-services.index') }}">
            ...
            @elseif (Request::route()->named('product-services.selhoz.show'))
                <span class="sep"> / </span>
                <span itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                    <a title="Товары и услуги" itemprop="item" href="{{ route('product-services.index') }}">
                        <span itemprop="name">Товары и услуги</span>
            ...
            @elseif (Request::route()->named('news-events.show'))
                <span class="sep"> / </span>
                <span itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
